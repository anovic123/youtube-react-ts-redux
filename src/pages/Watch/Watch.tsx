...
import { Navbar, WatchCard } from "../../components";
import { useAppDispatch, useAppSelector } from "../../hook/hook";
import { getRecommendedVideos } from "../../redux/slices/youtube/getRecommendedVideosAPI";
import { getVideoDetails } from "../../redux/slices/youtube/getVideoDetailsAPI";
...
export const Watch = () => {
  const [showMoreStatus, setShowMoreStatus] = React.useState<boolean>(false);
  const { id } = useParams();
